...
def aggregate_values(census_data, areal_weights, polygon_id_col):
    ...
    census_values = census_areal.drop(["GEOID", "NAME", "intersection_weight"], axis = 1)
...
def main(census_geo, census_data, polygons, polygon_id_col, crs = "EPSG:2263"):
    ...
    sums = aggregate_values(census_data, areal_weights, polygon_id_col)
